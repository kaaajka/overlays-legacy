        ...
        if(!!speech) {
            if(speech.readNickname) {
                ...
                if (speechNicknameUrl) {
                    await this.playSound(speechNicknameUrl, speech.volume, false, "Donate nickname TTS", "tts-nickname");
                }
            }
            if(speech.readAmount) {
                ...
                if (speechAmountUrl) {
                    await this.playSound(speechAmountUrl, speech.volume, false, "Donate amount TTS", "tts-amount");
                }
            }
            if(speech.readMessage) {
                ...
                if (speechMessageUrl) {
                    await this.playSound(speechMessageUrl, speech.volume, false, "Donate message TTS", "tts-message");
                }
            }
        }

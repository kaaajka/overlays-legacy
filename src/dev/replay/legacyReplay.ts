...
export function isDevFixtureAudioMuted(
  search = window.location.search,
): boolean {
...
export function isDevFixtureFastMode(
  search = window.location.search,
): boolean {
...
export function getMutedFixtureAudioDelayMs(
  options: MutedFixtureAudioDelayOptions = {},
): number {
...
export function shouldWaitForFixtureAudioUnlock(
  search = window.location.search,
): boolean {
  return (
